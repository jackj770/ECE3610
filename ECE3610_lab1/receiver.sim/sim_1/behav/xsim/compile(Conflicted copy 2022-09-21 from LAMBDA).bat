...
REM
REM Generated by Vivado on Wed Sep 21 12:25:51 -0600 2022
...
echo "xvhdl --incr --relax -prj receiver_tb_vhdl.prj"
call xvhdl  --incr --relax -prj receiver_tb_vhdl.prj -log xvhdl.log
